...
public:
  ...
  Matrix(size_t size1, size_t size2) {
    this->size1 = size1;
    this->size2 = size2;
    ((std::vector<type_d>*)this)->resize(size1 * size2);
  }
...
class solver : public QObject {
    ...
    void calc_r_vec(Matrix& v, std::vector<type_d>& res);
    ...
    void step_msi(Matrix& v, Matrix& z, type_d a, type_d c, type_d& mz, type_d& acc, type_d& tau);
    void step_msi(Matrix& v, type_d a, type_d c, type_d& acc, type_d& tau);
